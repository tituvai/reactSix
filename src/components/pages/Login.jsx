            ...
            <Container>
               ...
               <Hadding className={'text-[49px] text-hoverC font-bold'} text={'Login'} as={'h3'}/>
                ...
                <div className="border-b-1 border-borderC py-5">
                    <Hadding className={'w-[644px] text-base text-menuC'} text={"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the."} as={'p'}/>
                </div>
                <div className="">
