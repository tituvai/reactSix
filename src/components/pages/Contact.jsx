         ...
         <Container>
             <div className="py-20">
               <Hadding className={'text-[49px] text-hoverC font-bold'} text={'Contacts'} as={'h3'}/>
                ...
                <div className="">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3652.1585016980266!2d90.3799100239697!3d23.74172658911187!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sCreative%20IT%20Institute%2C!5e0!3m2!1sen!2sbd!4v1753288672830!5m2!1sen!2sbd" className='w-full h-[527px]' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
         </Container> 
        </div>
    </>
